...
<html lang="en">
  <head>
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <link rel="stylesheet" href="isalaregform.css" />
    ...
    <nav class="navbar navbar-expand-lg bg-danger">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0 ">
          <li class="nav-item">
            <a class="nav-link active text-light d-inline" href="homepage.html">Home</a>
            <li class="nav-item">
...
<div class="row">
  ...
  <?php }?>
   ...
   if(isset($_POST['create'])){
     ...
     $result = $stmtinsert->execute([$firstname, $surname, $lastname, $username, $emailID, $studentsLRN, $password]);
 ...
 ?>
    ...
    <form method="POST" action="" class="frm">
     ...
     <div>
      ...
      <input id="Login" type="submit" class="submit-btn" name="create" onclick="validate()"> 
       <a href="login.html">
      <input id="Admin" type="button" value="Back" onclick="history.back() "> 
